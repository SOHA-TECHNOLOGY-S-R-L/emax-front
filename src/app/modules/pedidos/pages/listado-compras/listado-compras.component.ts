...
import { ELEMENTOS_POR_PAGINA, PEDIDO_COMPRA, PRIMERA_PAGINA, SIGUIENTE_PAGINA, ULTIMA_PAGINA } from '../../../../constants/constantes';
...
export class ListadoComprasComponent implements OnInit, AfterViewInit {
  ...
  loadItems(): void {
    try {
      ...
      this.pedidoService.getAllPedidosPageable(params, PEDIDO_COMPRA).subscribe(response => {
